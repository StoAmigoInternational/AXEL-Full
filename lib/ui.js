...
var uiSocialLinks = function() {
	...
	if (linkToPhoneNumber && usePhoneIcon === true) {
		$(socialItems).append('<li><a href="#" class="go-phone"><i class="fa fa-phone" aria-hidden="true"></i></a></li>');
	}
	...
	if (linkToEmail && useEmailIcon === true) {
		$(socialItems).append('<li><a href="#" class="go-email"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>');
	...
	if (linkToBehance) {
		...
		$(socialItems).append('<li><a href="#" class="text-behance-hover go-behance"><i class="fa fa-behance" aria-hidden="true"></i></a></li>');
	...
	if (linkToCodepen) {
		...
		$(socialItems).append('<li><a href="#" class="text-codepen-hover go-codepen"><i class="fa fa-codepen" aria-hidden="true"></i></a></li>');
	...
	if (linkToDribble) {
		...
		$(socialItems).append('<li><a href="#" class="text-dribble-hover go-dribble"><i class="fa fa-dribble" aria-hidden="true"></i></a></li>');
	...
	if (linkToEtsy) {
		...
		$(socialItems).append('<li><a href="#" class="text-etsy-hover go-etsy"><i class="fa fa-etsy" aria-hidden="true"></i></a></li>');
	...
	if (linkToFacebook) {
		...
		$(socialItems).append('<li><a href="#" class="text-facebook-hover go-facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>');
	...
	if (linkToGithub) {
		...
		$(socialItems).append('<li><a href="#" class="text-github-hover go-github"><i class="fa fa-github" aria-hidden="true"></i></a></li>');
	...
	if (linkToGooglePlus) {
		...
		$(socialItems).append('<li><a href="#" class="text-google-plus-hover go-google-plus"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>');
	...
	if (linkToInstagram) {
		...
		$(socialItems).append('<li><a href="#" class="text-instagram-hover go-instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>');
	...
	if (linkToLinkedIn) {
		...
		$(socialItems).append('<li><a href="#" class="text-linkedin-hover go-linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>');
	...
	if (linkToMedium) {
		...
		$(socialItems).append('<li><a href="#" class="text-medium-hover go-medium"><i class="fa fa-medium" aria-hidden="true"></i></a></li>');
	...
	if (linkToPinterest) {
		...
		$(socialItems).append('<li><a href="#" class="text-pinterest-hover go-pinterest"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>');
	...
	if (linkToReddit) {
		...
		$(socialItems).append('<li><a href="#" class="text-reddit-hover go-reddit"><i class="fa fa-reddit" aria-hidden="true"></i></a></li>');
	...
	if (linkToSkype) {
		...
		$(socialItems).append('<li><a href="#" class="text-skype-hover go-skype"><i class="fa fa-skype" aria-hidden="true"></i></a></li>');
	...
	if (linkToSlack) {
		...
		$(socialItems).append('<li><a href="#" class="text-slack-hover go-slack"><i class="fa fa-slack" aria-hidden="true"></i></a></li>');
	...
	if (linkToSnapchat) {
		...
		$(socialItems).append('<li><a href="#" class="text-snapchat-hover go-snapchat"><i class="fa fa-snapchat" aria-hidden="true"></i></a></li>');
	...
	if (linkToTumblr) {
		...
		$(socialItems).append('<li><a href="#" class="text-tumblr-hover go-tumblr"><i class="fa fa-tumblr" aria-hidden="true"></i></a></li>');
	...
	if (linkToTwitch) {
		...
		$(socialItems).append('<li><a href="#" class="text-twitch-hover go-twitch"><i class="fa fa-twitch" aria-hidden="true"></i></a></li>');
	...
	if (linkToTwitter) {
		...
		$(socialItems).append('<li><a href="#" class="text-twitter-hover go-twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>');
	...
	if (linkToVimeo) {
		...
		$(socialItems).append('<li><a href="#" class="text-vimeo-hover go-vimeo"><i class="fa fa-vimeo" aria-hidden="true"></i></a></li>');
	...
	if (linkToWhatsApp) {
		...
		$(socialItems).append('<li><a href="#" class="text-whatsapp-hover go-whatsapp"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>');
	...
	if (linkToYelp) {
		...
		$(socialItems).append('<li><a href="#" class="text-yelp-hover go-yelp"><i class="fa fa-yelp" aria-hidden="true"></i></a></li>');
	...
	if (linkToYoutube) {
		...
		$(socialItems).append('<li><a href="#" class="text-youtube-hover go-youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>');
...
var uiNav = function() {
	...
	//$(navPanel).hasClass("is-open");

	// CONTROLLER
	var ScrollMagicScrollToController = new ScrollMagic.Controller({
		container: html, // Reset this to 'html'.
		vertical: true,
		globalSceneOptions: {
			triggerHook: "onEnter"
		},
	...
	// ANIMATION
	ScrollMagicScrollToController.scrollTo(function(newPosition) {
		
		if (isEdge) {
			
			TweenMax.to(body, scrollToSpeed, {scrollTo: {y: newPosition, offsetY: scrollToOffsetY, autoKill: true}, ease: scrollToEase});
			
		} else {
			
			TweenMax.to(html, scrollToSpeed, {scrollTo: {y: newPosition, offsetY: scrollToOffsetY, autoKill: true}, ease: scrollToEase});
	...
	// SCENE
	var ScrollMagicScrollToScene = new ScrollMagic.Scene({triggerElement: null})
		.addTo(ScrollMagicScrollToController);

	// BIND SCROLL EVENT
	$(".scroll-to").on("click", function(e) {
		
		if ( navPanelCloseOnLinkClick === false ) {
			
			$(navPanelItems).find("li").find(".scroll-to").removeAttr("data-toggle", ''+navPanel.substring(1)+'');

		}

		if ( !isTouch && allowScrollTo === true ) { // 'scrollTo' animation disabeld on Edge. What a surprise!
			...
			if ($(hash).length > 0) {
				...
				// Trigger 'ScrollMagicScrollToController'.
				ScrollMagicScrollToController.scrollTo(hash);
    ...
    */
	...
	var tlPanelOverlay = new TimelineMax({paused: true, delay: 0, repeat: 0, repeatDelay: 0, yoyo: false, onStart: function() {
											 
                                             
													//$(navbar).addlass("pointer-disabled");
													//$(toolbar).addClass("pointer-disabled");
                                             
													TweenMax.to(panelOverlay, panelOverlayTransitionSpeed, {autoAlpha: 1, delay: 0.12, ease: Expo.easeOut});
											 		
											 		// Animate 'content' when 'navPanel' is opened.
											 		if ( animateContentOnNavPanelOpen === true && !isTouch ) {
										 ...
										 onComplete: function() {
													tlNavPanelItems.timeScale(1).play();
										 },
										 onReverseComplete: function() {
											 
													tlNavPanelItems.timeScale(2).reverse();
                                             
													//$(navbar).removeClass("pointer-disabled");
													//$(toolbar).removeClass("pointer-disabled");

													TweenMax.to(panelOverlay, panelOverlayTransitionSpeed, {autoAlpha: 0, delay: parseFloat(navPanelTransitionSpeed.replace(/ms/,"").replace(/s/,"")) + panelOverlayDelay, ease: Expo.easeOut});
													...
													if (navPanelScrollReset === true) {
														TweenMax.set(navPanel, {scrollTo: {y: 0, offsetY: 0, autoKill: true}});
													}
	...
	// NAV ITEMS ANIMATION
	TweenMax.set($(".nav-items").children(), {force3D: true});
    TweenMax.set($(contactInfo), {force3D: "auto"});
    TweenMax.set($(socialItems), {force3D: "auto"});
    
	var tlNavPanelItems = new TimelineMax({paused: true, delay: 0.5, repeat: 0, repeatDelay: 0, yoyo: false,
										 onStart: function() {

													//console.log("Start");
                                             		$(navbarToggle).find(".nav-toggle").addClass("active").addClass("opacity-00");
										 ...
										 onReverseComplete: function() {
													...
													//console.log("Reverse complete");
                                             		$(navbarToggle).find(".nav-toggle").removeClass("active").removeClass("opacity-00");

										 }
							 });

		tlNavPanelItems.staggerFrom($(navPanel).find("#nav-panel-contents").children().children(), 0.75, {autoAlpha: 0, x: -20, ease: Expo.easeInOut}, 0.12)
					   .staggerFrom($(contactInfo), 0.5, {autoAlpha: 1, x: -20, ease: Expo.easeInOut}, 0.12)
					   .staggerFrom($("#nav-panel-social-icons"), 0.5, {autoAlpha: 0, x: -20, ease: Expo.easeInOut}, 0.12);

	/*
	var tlNavPanelItems = new TimelineMax({paused: true, delay: 5, repeat: 0, repeatDelay: 0, yoyo: false,
										 onStart: function() {
		...
		tlNavPanelItems.staggerFrom(navPanelItemsText, 0.25, {autoAlpha: 0, y: 25, delay: 0, ease: Expo.easeOut}, 0.12);
    */
	...
	$(navPanel).on("opened.zf.offcanvas", function() {
		...
		$(navbar).addClass("pointer-disabled");
		$(toolbar).addClass("pointer-disabled");
        
		tlPanelOverlay.play();
		
		//$("#particles-js").prependTo(navPanel);
	...
	$(navPanel).on("closed.zf.offcanvas", function() {
		...
		tlPanelOverlay.reverse();
		
		//$("#particles-js").insertAfter("#background-gradient");
...
var uiRelayout = function() {  
	...
	if ( showToolbar === true && toolbarHideOnScrollDown === true || showToolbar === true && toolbarShowOnPageEnd === true ) {
		...
		$(main).children(article + ":last-child").css({"padding-bottom": (parseFloat(toolbarShowOnPageEndHeight.replace(/px/,"")) / 16 + 0) + "rem"});
